...
// Etape n°1 
 ...
 $RECHERCHE ="get_users_nom_complet_1";
 $RECHERCHE ="get_users_nom_complet";
 //$RECHERCHE ="get_users_nationality";
 //$RECHERCHE ="get_users_naissance2";
 //$RECHERCHE ="get_users_naissance";
 //$RECHERCHE ="get_result_villes_nom";
 //$RECHERCHE ="get_result_users_perf2";
 //$RECHERCHE ="get_result_users_perf";

// $RECHERCHE ="get_result_users_nom_2";
 //$RECHERCHE ="get_result_users_nom_1";
 //$RECHERCHE ="get_result_date_perf";
 //$RECHERCHE ="get_epreuve_nom_complet";
 //$RECHERCHE ="get_result_users_nom_0";
 //$RECHERCHE ="get_epreuve_emplacement";
 //$RECHERCHE ="get_club_region";
 //$RECHERCHE ="get_club_nom_complet";
 //$RECHERCHE ="get_club_departement";
 //$RECHERCHE ="get_cat";


// $apple->set_sql('SELECT DISTINCT(`'.$RECHERCHE.'`)FROM `info_all` WHERE 1  ORDER BY `'.$RECHERCHE.'`  LIMIT 100;');

 $apple->set_sql('SELECT * FROM info_all WHERE `get_club_nom_complet` LIKE "N%" ORDER BY `get_club_nom_complet`;');

 
 // Etape idependante creation d'une table 1_001

 /*
 $apple->action_all('CREATE TABLE test_vshowcoordsalid (
...
for($i= 0 ; $i<count($apple->variable_switch_0) ; $i++){
    echo $apple->variable_switch_0[$i] ;
    echo "<br/>" ; 
