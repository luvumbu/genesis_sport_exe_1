...
$dbname = "u481158665_ffa";
    ...
    $get_club_departement = $_POST["get_club_departement"] ;
    $get_club_nom_complet = $_POST["get_club_nom_complet"] ;

    $get_club_region = $_POST["get_club_region"] ;
    $get_epreuve_emplacement = $_POST["get_epreuve_emplacement"] ;
    $get_result_users_nom_0 = $_POST["get_result_users_nom_0"] ;
    $get_epreuve_nom_complet = $_POST["get_epreuve_nom_complet"] ;
    $get_result_date_perf = $_POST["get_result_date_perf"] ;

    $get_result_users_nom_1 = $_POST["get_result_users_nom_1"] ;
    $get_result_users_nom_2 = $_POST["get_result_users_nom_2"] ;
    $get_result_users_perf = $_POST["get_result_users_perf"] ;
    $get_users_nom_complet = $_POST["get_users_nom_complet"] ;
    $get_result_users_perf2 = $_POST["get_result_users_perf2"] ;

    $get_result_villes_nom = $_POST["get_result_villes_nom"] ;
    $get_users_naissance = $_POST["get_users_naissance"] ;
    $get_users_naissance2 = $_POST["get_users_naissance2"] ;
    $get_users_nationality = $_POST["get_users_nationality"] ;
   

    $get_users_nom_complet_1 = $_PO["get_users_nom_complet_1"] ;
...
// insertion
              ...
              if ($conn_00_1->query($sql_00_1) === TRUE) {
                echo "Club departement add ok New record created successfully";
              } else {
