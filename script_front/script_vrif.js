...
/*
   ...
   // valeur a verifier dans le fichier javascript
   //r2.set_call(get_club_region[0]); //data_full_name  
   //data_full_name
   //premier valeur dans le tableau d'appelation
   //direction_envoie
   //"switchs.php"
...
/*
     // mode 3
	 var r3 = new Information_envoie();
	 var verif_recherche = get_result_club_departement;
	 //alert(get_club_nom_complet[0]);
	 
	 r3.set_source_envoie(verif_recherche);    
	 r3.set_call(switch_name[2]); //data_full_name
	 r3.set_datas_(verif_recherche);   
	 // valeur a verifier dans le fichier javascript
	 //r3.set_call(get_club_region[0]); //data_full_name  
	 //data_full_name
	 //premier valeur dans le tableau d'appelation
	 //direction_envoie
	 //"switchs.php"
	 r3.set_switchs(direction_envoie);     
	 try {  
	  resul_get =get_result_users_nom_0[0].toLowerCase();
	  jenvoie= true; 		
  }
  ...
  function_dossier(r3.get_call());
  r3.set_source_recherche(direction_envoie_internet+"data/data_country_name/data_country_name_az_.php");
  r3.execution();
...
/*
	     // mode 3
		 var r4 = new Information_envoie();
		 var verif_recherche = get_club_region;
		 //alert(get_club_nom_complet[0]);
		 
		 r4.set_source_envoie(verif_recherche);    
		 r4.set_call(switch_name[3]); //data_full_name
		 r4.set_datas_(verif_recherche);   
		 // valeur a verifier dans le fichier javascript
		 //r4.set_call(get_club_region[0]); //data_full_name  
		 //data_full_name
		 //premier valeur dans le tableau d'appelation
		 //direction_envoie
		 //"switchs.php"
		 r4.set_switchs(direction_envoie);     
		 try {  
		  resul_get =get_result_users_nom_0[0].toLowerCase();
		  jenvoie= true; 		
	  }
	  ...
	  function_dossier(r4.get_call());
	  r4.set_source_recherche(direction_envoie_internet+"data/data_country_number/data_country_number_az_.php");
	  r4.execution();
		...
		// ---MOD2---*
	     ...
	     // mode 3
		 var r6 = new Information_envoie();
		 var verif_recherche = get_users_nationality;
		 //alert(get_club_nom_complet[0]);
	  ...
	  r6.set_source_envoie(verif_recherche);    
	  r6.set_call(switch_name[5]); //data_full_name
	  r6.set_datas_(verif_recherche);   
	  // valeur a verifier dans le fichier javascript
	  //r6.set_call(get_club_region[0]); //data_full_name  
	  //data_full_name
	  //premier valeur dans le tableau d'appelation
	  //direction_envoie
	  //"switchs.php"
	  r6.set_switchs(direction_envoie);     
	  try {  
	   resul_get =get_result_users_nom_0[0].toLowerCase();
	   jenvoie= true; 		
   }
   ...
   function_dossier(r6.get_call());
   r6.set_source_recherche(direction_envoie_internet+"data/data_nationality/data_nationality_az_.php");
   r6.execution();
